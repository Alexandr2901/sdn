...
echo '<?xml version="1.0" encoding="UTF-8"?> 
  <l2switch-main-config xmlns="urn:opendaylight:packet:l2switch-main-config">
  <dropall-flow-table-id>3</dropall-flow-table-id>
  <reactive-flow-table-id>3</reactive-flow-table-id> 
</l2switch-main-config>' > ../etc/opendaylight/datastore/initial/config/l2switch-main-config_l2switch-main-config.xml
